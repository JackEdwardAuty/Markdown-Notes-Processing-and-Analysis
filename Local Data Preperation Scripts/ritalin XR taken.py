...
meds["Ritalin_Taken"] = meds[med_col].isin(["Ritalin XR"]).astype(int)
...
daily.to_csv("ritalin_XR_daily_tableau.csv", index=False)
print("Written ritalin_XR_daily_tableau.csv")
